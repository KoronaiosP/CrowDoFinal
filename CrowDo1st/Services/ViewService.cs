...
namespace CrowDo1st
{
    public class ViewService : IViewService
    {
        ...
        public Result<List<string>> ViewProjects()
        {
            ...
            return new Result<List<string>> { ErrorCodeId = 0, ErrorCodeString = "ok", Data = allProjects };
        }
        ...
        public Result<List<ProjectProfilePage>> FundedProjects(string email)
        {
            ...
            return new Result<List<ProjectProfilePage>> { ErrorCodeId = 0, ErrorCodeString = "OK", Data = fundedProjects };
        ...
        public Result<List<string>> ViewByYear(int year)
        {
            ...
            return new Result<List<string>> { ErrorCodeId = 0, ErrorCodeString = "OK", Data = listOfProjects };
        }
        ...
        public Result<List<string>> ViewDetailsOfProject(string title)
        {
            ...
            return new Result<List<string>> { ErrorCodeId = 0, ErrorCodeString = "OK", Data = details };
        }
        ...
        public Result<string> MostVisitedProject()
        {
            ...
            return new Result<string> { ErrorCodeId = 0, ErrorCodeString = "OK", Data = maxViewd };
        }
